...
class RoomRequestsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_room_requests, container, false)
        auth= FirebaseAuth.getInstance()

        arrayList=ArrayList()
        recyclerView=view.findViewById(R.id.recycler_room_request_items)
